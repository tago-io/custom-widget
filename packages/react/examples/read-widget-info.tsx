/**
 * Read Widget Info Example
 *
 * Shows how to access widget configuration, user information, and blueprint devices.
 * This is the React equivalent of the JavaScript "read-widget-info.html" example.
 * To read platform resources (device list, users, entities), see "read-resource.tsx".
 *
